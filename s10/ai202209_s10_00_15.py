...
#
# Time-stamp: <2022/11/20 20:18:06 (CST) daisuke>
#
...
# output file name
file_output = 'ai202209_s10_00_15.png'
...
ax.plot (ecl_ra, ecl_dec, \
         linestyle='None', marker='o', color='y', markersize=3, alpha=0.3, \
         label='Ecliptic plane')
ax.plot (ecl_ra, ecl_dec, \
         linestyle='None', marker='o', color='y', markersize=30, alpha=0.01)
